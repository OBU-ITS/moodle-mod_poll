...
class restore_poll_activity_task extends restore_activity_task {
     ...
     * poll logs. It must return one array
     * of {@link restore_log_rule} objects
     */
    static public function define_restore_log_rules() {
        $rules = array();

        $rules[] = new restore_log_rule('poll', 'add', 'view.php?id={course_module}', '{poll}');
        $rules[] = new restore_log_rule('poll', 'update', 'view.php?id={course_module}', '{poll}');
        $rules[] = new restore_log_rule('poll', 'view', 'view.php?id={course_module}', '{poll}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('poll', 'view all', 'index.php?id={course}', null);
